  ...
  return (
    <div className="container mx-auto px-4 max-w-[1100px] w-full">
      <div className="lg:grid lg:grid-cols-2 gap-4">
        <div className="bg-white border border-[#c4cdd5]  rounded-sm">
          <TextController setShadows={setShadows} />
        </div>
        <div className=" flex flex-col gap-4">
          <div className="border border-[#c4cdd5]  rounded-sm">
            ...
            <div className="p-9 " style={{ background: colorBg }}>
              <div style={{ boxShadow: shadows, color: colorItem }}>
                <p className="text-[80px] ">Hello SC</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-9 p-4 border border-[#c4cdd5]  rounded-sm">
